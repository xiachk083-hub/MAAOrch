...
�?                                                                                  �?
�? ┌────────────────────�? ┌────────────────────�? ┌────────────────────────────�? �?
�? �?配置写入注入        �? �?MAA 实例池管�?    �? �?进程与队列管�?             �? �?
�? �?config_injector.py      �? �?maint_ops.py       �? �?launch_queue + runner      �? �?
�? �?                   �? �?                   �? �?                           �? �?
�? �?读账号配�?         �? �?maa/source/ 用户目录�? �?排队 �?分配实例             �? �?
�? �?生成 gui.json      �? �? �?目录软链�?      �? �? �?启动 MAA                �? �?
�? �?生成 gui.new.json  �? �?instances/1..N     �? �? �?监控日志 �?清理 �?重试   �? �?
�? �?注入 TaskQueue     �? �?每个实例独立配置     �? �? �?诊断收集                 �? �?
�? └────────────────────�? └────────────────────�? └────────────────────────────�? �?
�?                                                                                  �?
�? ┌────────────────────�? ┌────────────────────�? ┌────────────────────────────�? �?
�? �?智能调度引擎        �? �?日志解析与统�?    �? �?环境检测与修复              �? �?
�? �?smart_scheduler.py �? �?log_ops + stats   �? �?health_check.py            �? �?
�? �?                   �? �?                   �? �?                           �? �?
�? �?理智阈值触�?       �? �?解析 asst.log      �? �?检�?10 �?                 �? �?
�? �?基建时间触发        �? �?统计运行次数/掉落  �? �?Python/PySide6/ADB/MAA     �? �?
�? �?材料库存监控        �? �?理智恢复计算       �? �?配置/实例/备份/日志        �? �?
�? �?剿灭自动检�?       �? �?存档�?stats.json  �? �?一键修�?                  �? �?
�? └────────────────────�? └────────────────────�? └────────────────────────────�? �?
�?                                                                                  �?
�? ┌────────────────────�? ┌────────────────────�? ┌────────────────────────────�? �?
�? �?异常自动恢复        �? �?性能资源监控       �? �?主题系统                   �? �?
...
�? �?                   �? �?resources          �? �?                           �? �?
�? �?指数退避重�?       �? �?                   �? �?暗色主题                   �? �?
�? �?关游�?(ADB)       �? �?系统可用内存 < 4GB �? �?亮色主题                   �? �?
�? �?重启模拟器实�?     �? �?自动暂停新启�?    �? �?Notepaper 暖白纸张主题     �? �?
�? �?诊断收集保存        �? �?单进�?> 4GB 杀   �? �?竹绿配色                   �? �?
�? �?连续 6+ 次暂�?    �? �?状态栏显示内存使用  �? �?                           �? �?
�? └────────────────────�? └────────────────────�? └────────────────────────────�? �?
�?                                                                                  �?
└───────────────────────────────────────────────────────────────────────────────────�?
...
用户目录 maa/source/（用户自行管理版本和完整性）
     �?
     �?_find_maa_source() 优先检�?source/
     �?_create_instance() 复制文件 + 创建软链�?
     �?
实例�?maa/instances/{1..N}/
     �?
     ├─ MAA.exe              �?复制（小文件，几 MB�?
     ├─ MAA.dll               �?复制
     ...
     ├─ ... 其他 DLL          �?复制
     �?
     ├─ config/               �?�?source 复制（含完整 TaskQueue + $type�?
     �?  ├─ gui.json          �?MAA v5 格式（不�?TaskQueue�?
...
每次启动 ensure_maa_instances_async()
  ├─ 比较 maa/source/MAA.exe �?instances/1/MAA.exe 的修改时�?大小
  �?  ├─ 不同 �?删除旧实�?�?重建全部
  �?  └─ 相同 �?跳过
  �?
...
```
  ...
  �?  �? �?5 �?�?80s                              �?
  �?  �?                                             �?
  �?  ├─ 重启模拟�?(mumu-cli quit + launch)        �?
  �?  ├─ ADB force-stop 关游�?                      �?
  �?  ├─ 每分钟重�?> 4 �?�?限流 5 分钟              �?
  �?  └─ 连续失败 �?6 �?暂停该账�?30 分钟 + 通知    �?
  └──────────────────────────────────────────────────�?
```
...
�? �?                                          �?
�? ├─ 体力是否 �?80% 阈值？                    �?
�? �?  �?触发刷关（读 stats.json�?0s 缓存�?  �?
�? �?                                          �?
�? └─ 材料库存不足�?                          �?
�?     �?触发刷材料关卡（�?depot.json 缓存�?  �?
�?                                            �?
...
ServiceContext (callbacks.py)
    ...
    �?      �?      �?
    �?      �?      └─ �?maa/source/ 加载 TaskQueue 模板
    �?      �?         �?IsEnable / StagePlan / Annihilation
    �?      �?         写入文件
    �?      �?
...
| `launch_queue.py` | 启动队列、优先级排队、模拟器独占、平行限�?| `LaunchQueue`, `enqueue`, `_tick`, `on_account_finished` |
| `runner.py` | MAA 进程全生命周期（启动/监控/卡死/清理/重试/诊断�?| `AccountRunner`, `launch`, `_check_one`, `_cleanup`, `_update_status` |
| `config_injector.py` | MAA 配置写入（gui.json + gui.new.json 注入�?| `ConfigService`, `inject_smart`, `inject` |
| `maint_ops.py` | 实例池创�?删除/重建、MAA 下载、维护任�?| `ensure_maa_instances_async`, `_create_instance`, `_init_maa_source` |
| `smart_scheduler.py` | 智能调度决策（理�?时间/材料/剿灭�?| `decide`, `_check_sanity_above_threshold`, `_get_material_stage` |
| `log_ops.py` | asst.log 解析、运行统计、日志轮�?| `LogService`, `parse_log`, `show_stats`, `rotate_log` |
| `health_check.py` | 环境检测与修复�?0 项检查） | `run_health_check`, `show_health_dialog` |
| `themes.py` | 暗色/亮色/Notepaper 主题 | `DARK_STYLE`, `LIGHT_STYLE`, `NOTEPAPER_STYLE` |
| `account.py` | 账号数据模型（dataclass�?| `Account`, `from_dict`, `to_dict` |
| `config.py` | config.json 读写（原子写�?+ 备份 + 迁移�?| `load_config`, `save_config`, `migrate_v4_to_v5` |
| `task_constants.py` | 任务模板、模拟器检测、ADB 查找、状态枚�?| `TASK_NAMES`, `TASK_DEFAULTS`, `find_mumu_cli`, `detect_emu_instances` |
| `emu_ops.py` | ADB 测试/截图、模拟器列表/刷新 | `EmuService`, `test_adb`, `refresh_instance_list` |
| `stats.py` | 运行统计读写 | `RunStats`, `save_run`, `get_last_sanity` |
| `dialogs.py` | 设置/定时/账号编辑/任务配置对话�?| `ScheduleDialog`, `SettingsDialog`, `AccountDialog`, `TaskSettingsDialog` |
| `ui/rebuild_dialog.py` | 重建实例进度对话�?| `RebuildDialog` |
| `background.py` | QThread 包装工具 | `BackgroundTask` |
| `api_server.py` | HTTP REST API�?5+ 端点�?| `ApiServer` |
...
══════════════════════════════════════════════�?
  ...
  maa_version: "v6.11.1"
  maa_instances: 当前实例池数�?
  maa_instances_version: 实例池基于的 MAA 版本
  accounts: [Account, Account, ...]          �?39 �?
...
inject_smart(task_list, ac, config_dir)
    ...
    ├─ �?TaskSelectedIndex = 0
    �?
    ├─ �?gui.json (v5 格式, 含扁平键, TaskQueue 移除)
    �?
    └─ �?gui.new.json (v6 格式, �?$type + TaskQueue)
```
...
[16:23:29] [账号] 1 状�? completed (exit=0)
[16:23:30] [状态] 运行�? 2/39 | 队列: 0 | 错误: 0
...
| 指示�?| 变量 | 格式 | 说明 |
|--------|------|------|------|
| 左侧文本 | `self.sl` | `就绪` / `MAA: 刷关...` | 当前操作状态或 MAA 任务�?|
| 运行/队列 | `self._qsb` | `�?` / `�? �?` / `�?` | 运行中账号数 / 排队等待�?|
| 健康状�?| `self._health_indicator` | `✅` / `�?2` | 环境检测结果，绿色=正常、黄�?N个问题，点击打开检测面�?|
| 资源监控 | `self._resource_lbl` | `MEM:6.2GB/16GB(2)` | 系统已用内存/总内�?MAA进程�?，后�?`⚠` 表示内存不足新启动已暂停 |
