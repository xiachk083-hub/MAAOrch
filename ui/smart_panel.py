...
def build_smart_panel(mw: Any) -> QWidget:
    ...
    mw._smart_search.setStyleSheet("QLineEdit{background:#222;color:#ddd;border:1px solid #333;border-radius:5px;padding:4px 10px;font-size:9pt}")
    ...
    add_btn.setStyleSheet("QPushButton#startBtn{background:#498205;color:#fff;border:1px solid #498205;border-radius:5px;padding:4px 16px;font-size:9pt;font-weight:bold}")
